...
SECRET_KEY = 'django-insecure-a*xts(+d=ydh$8b-fh)6o4c*=4qia6#hs7=zta=#hd7gs4a5c8'
...
# Define the URL that media files will be accessed through.
MEDIA_URL = '/media/'
